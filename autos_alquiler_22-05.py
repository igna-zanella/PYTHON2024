...
usuariosActivos = {'s':'1234','vendedor':'5678','tecnico':'91011'}
autos = {"ABC123":{"km":0, "precio":0,"tipo":"alquiler", "disponibilidad":"si"}, "HLS555":{"km":50000, "precio":13000000,"tipo":"alquiler", "disponibilidad":"si"},"AB976CC":{"km":20000, "precio":19000000,"tipo":"venta", "disponibilidad":"no"},"AD571RA":{"km":10000, "precio":42000000,"tipo":"alquiler", "disponibilidad":"si"},"GSM788":{"km":20000, "precio":19000000,"tipo":"venta", "disponibilidad":"no"}}
...
""")
                            ...
                            if opcSub == "A":
                                ...
                                autos[patente] = {"km":km, "precio":precio, "tipo":tipo, "disponibilidad": "SI"}
                                for key in autos: #Obtenemos la key de cada elemento dentro del diccionario 
                                    
                                    print("El partido '{}' tiene {} votos".format(key,autos[key]))
                                print(autos)
                                ...
                                # for clave, valor in autos.items():
                                    
                                #     elementos = ", ".join(valor.keys())
                                #     print(clave, ":", elementos)
                                
                                if "SI" in autos["ABC123"].values():
                                    print("qqq")
                                for v1 in autos.values():
                                    if "si" and "alquiler" in v1.values():
                                        print("www") 
