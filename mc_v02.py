...
if opcion > 7 or opcion < 1:
    ...
    print("\nTu combo sale " + '\033[32m' + "$" + str(precios[opcion-1]) + '\033[0m')
    
    agrandarCombo = input("\n¿Deseás mejorarlo? (S = sí // N = no) ").upper()
    ...
    """ + '\033[0m')
        ...
        if opcionCombo > 4 or opcionCombo < 1:
            ...
            print("Hasta acá pagás " + '\033[32m' + "$" + str(precios[opcion-1]) + '\033[0m')
...
while n:    
    ...
    ╚═══════════════════════════════════╝ 
            ...
            if cuota == "1":
                ...
                print("\nEl importe total es " + '\033[32m' + "$" + str(total) + '\033[0m', "en 2 cuotas de " + '\033[32m' + "$" + '\033[32m' + str(round(total/2, 2)) + '\033[0m')
                c = False
            elif cuota == "3":
                total = total + (total * .35) 
                print("\nEl importe total es " + '\033[32m' + "$" + str(total) + '\033[0m', "en 3 cuotas de " + '\033[32m' + "$" + '\033[32m' + str(round(total/3, 2)) + '\033[0m')
                c = False
            else:
                print('\033[31m' + "\nOpción no válida" + '\033[0m')
        print('\033[33m' + "Prepará tu tarjeta y seguí las instrucciones del posnet ¡Disfrutá tu combo!" + '\033[0m')
